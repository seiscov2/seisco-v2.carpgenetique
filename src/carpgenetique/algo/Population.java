...
public class Population implements Concept {
    ...
    */
    public List<Individu> genererIndividus(int nombre, ProblemeCARP p) {
        List<Individu> listeIndividus = new ArrayList<Individu>();
        int i=0;
        ...
        for( ; i < nombre; i++) {
            ...
            listeIndividus.add(nouvelIndividu);
        }
    ...
    /**
     * <p>
     * Trie la {@link Population} par ordre décroissant de fitness.
        ...
        do {
            ...
            for(int i = 0; i<longueur-1; i++)
                if(individus.get(i).getFitness() < individus.get(i+1).getFitness()){
                    Individu ind1 = individus.get(i+1);
                    individus.set(i+1, individus.get(i));
                    individus.set(i, ind1);
                    inversion=true;
                }
        } while(inversion);
    }
